...
const translations = {
  en: {
    ...
    "tab.diff.description": "Review recent file changes from Codex in a mobile-friendly diff view.",
    "tab.code.title": "Code",
    "tab.code.label": "Code",
    "tab.code.eyebrow": "Code changes",
    "tab.code.description": "Review recent file changes from Codex in a mobile-friendly diff view.",
    ...
    "empty.diff": "No file changes are available yet.",
    ...
    "detail.diffThread.copy": ({ count }) =>
      `This thread includes ${count} ${count === 1 ? "changed file" : "changed files"}. Review each file below.`,
    ...
    "summary.diffThread": "Review the file changes collected in this thread.",
    ...
    "intent.diffThread": "Review the file changes collected in this thread.",
    ...
    "diff.latestChangeFallback": "Latest change available in this thread.",
    ...
    "settings.remote.copy":
      "Keep using viveworker on your LAN as usual, then temporarily issue an external URL before you head out.",
    "settings.remote.configureOnMac":
      "Configure remote access on your Mac first with `npx viveworker setup --access-mode viveworker` or `npx viveworker setup --access-mode cloudflare ...`.",
    "settings.remote.lanOnlyToggle":
      "Remote access can only be enabled or disabled from the LAN version of viveworker.",
    "settings.remote.publicUrlLabel": "External URL",
    "settings.remote.bootstrapUrlLabel": "Bootstrap URL",
    "settings.remote.enable": "Enable External Access",
    "settings.remote.disable": "Disable External Access",
    "settings.remote.copyUrl": "Copy External URL",
    "settings.remote.copyBootstrap": "Copy Bootstrap URL",
    "settings.remote.openBootstrap": "Open Bootstrap URL",
    "settings.remote.origin.lan": "LAN app",
    "settings.remote.origin.remote": "External URL",
    "settings.remote.expiresMinutes": ({ count }) => `${count} min`,
    "settings.remote.expiresHours": ({ count }) => `${count} hr`,
    "settings.remote.expiresDays": ({ count }) => `${count} day${count === 1 ? "" : "s"}`,
    ...
    "settings.row.currentOrigin": "Current origin",
    "settings.row.remoteUrl": "External URL",
    "settings.row.remoteExpires": "Expires at",
    "settings.row.remoteExpiresIn": "Expires in",
    "settings.row.remoteAllowEmails": "Allowed emails",
    ...
    "notice.remoteAccessEnabled": "External access is enabled. Copy the external URL before you head out.",
    "notice.remoteAccessEnabledTrusted": "External access is enabled. This iPhone is already trusted for the external URL.",
    "notice.remoteAccessDisabled": "External access is disabled.",
    "notice.remoteUrlCopied": "External URL copied.",
    "notice.remoteBootstrapCopied": "Bootstrap URL copied.",
    "notice.remoteBootstrapOpened": "Bootstrap URL opened in a new tab.",
    "error.networkHint":
    ...
    "error.copyUnavailable": "Copy is not available in this browser.",
    "error.remoteAccessNotConfigured": "Remote access is not configured on this Mac yet.",
    "error.remoteAccessLanOnly": "Remote access can only be changed from the LAN version of viveworker.",
    "error.remoteBootstrapInvalid": "This external access link is no longer valid.",
    "error.remoteBootstrapExpired": "This external access link expired. Enable remote access again from the LAN app.",
    "error.remoteBootstrapDeviceRevoked": "This iPhone is no longer trusted for remote access.",
    "error.remoteBootstrapUnavailable": "A bootstrap URL is not available right now.",
    ...
    "cli.help.usage": "Usage: viveworker <setup|remote|start|stop|status|doctor> [options]",
    "cli.help.commands": "Commands:",
    "cli.help.setup": "setup         Create config, generate pairing info, register launchd, start the bridge",
    "cli.help.remote": "remote        Managed remote commands (currently: rotate)",
    ...
    "cli.accessMode.lan": "LAN",
    "cli.accessMode.viveworker": "viveworker managed relay",
    "cli.accessMode.cloudflare": "Cloudflare Zero Trust",
    "cli.accessMode.vpn": "VPN",
    ...
    "cli.setup.progress.generateVpn": "Generating VPN certificates, profile, and strongSwan config...",
    "cli.setup.progress.remoteBootstrap": "Preparing remote access bootstrap...",
    ...
    "cli.setup.accessMode": "Access mode: {value}",
    "cli.setup.appUrl": "App URL: {url}",
    ...
    "cli.setup.pairingUrl": "Pairing URL: {url}",
    "cli.setup.pairingUrlLocal": "Pairing URL (.local): {url}",
    "cli.setup.pairingUrlIp": "Pairing URL (IP): {url}",
    "cli.setup.vpnEndpointHostname": "VPN endpoint hostname: {value}",
    "cli.setup.vpnProfilePath": "VPN profile file: {value}",
    "cli.setup.strongSwan": "strongSwan: {value}",
    ...
    "cli.setup.instructions.vpn":
      "Open the app URL in Safari, pair if needed, add viveworker to your Home Screen, and later connect the built-in iPhone VPN before opening it off-LAN.",
    "cli.setup.vpnFlow.title": "Before opening viveworker over VPN, install the generated iPhone VPN profile:",
    "cli.setup.vpnFlow.downloadProfile": "VPN profile download: {url}",
    "cli.setup.vpnFlow.profilePath": "VPN profile on this Mac: {value}",
    "cli.setup.vpnFlow.step1": "1. Open the VPN profile URL or scan the QR code below on your iPhone.",
    "cli.setup.vpnFlow.step2": "2. Install the profile, then trust the certificate when iPhone settings prompts you.",
    "cli.setup.vpnFlow.step3": "3. After that, press Enter here to show the viveworker app URL and pairing QR.",
    "cli.setup.vpnPortForward": "Router setup: forward UDP 500 and 4500 to this Mac for {host}.",
    "cli.setup.vpnFirstInstallNote":
      "First-time profile installation works best while your iPhone is on the same LAN as this Mac.",
    "cli.setup.remoteAccessProvider": "Remote access provider: {value}",
    "cli.setup.remoteAccessPublicUrl": "External URL: {url}",
    "cli.setup.remoteAccessStatus": "Remote access: {value}",
    "cli.setup.remoteAccessDisabledByDefault":
      "Remote access stays off by default. Turn it on from viveworker Settings on your iPhone before you leave.",
    "cli.setup.remoteAccessIphoneToggle":
      "On your iPhone, open Settings → Remote Access to issue the temporary external URL when you need it.",
    "cli.setup.remoteAccessAllowEmails": "Cloudflare Access allowlist: {value}",
    ...
    "cli.setup.qrVpnProfile": "VPN profile QR:",
    ...
    "cli.status.accessMode": "Access mode: {value}",
    "cli.status.envFile": "Env file: {value}",
    "cli.status.baseUrl": "Base URL: {value}",
    "cli.status.vpnEndpointHostname": "VPN endpoint hostname: {value}",
    "cli.status.vpnProfilePath": "VPN profile: {value}",
    "cli.status.strongSwan": "strongSwan: {value}",
    ...
    "cli.status.localProbeUrl": "Local probe URL: {value}",
    "cli.status.enabled": "enabled",
    "cli.status.disabled": "disabled",
    "cli.status.detected": "detected",
    "cli.status.missing": "missing",
    "cli.status.installed": "installed",
    "cli.status.notRunning": "not running",
    "cli.status.running": "running",
    "cli.status.expired": "expired",
    "cli.status.ok": "ok",
    "cli.status.failed": "failed",
    "cli.status.remoteConfigured": "Remote configured: {value}",
    "cli.status.remoteUrl": "Remote URL: {value}",
    "cli.status.remoteEnabled": "Remote active: {value}",
    "cli.status.remoteExpiresAt": "Remote expires at: {value}",
    "cli.status.remoteControlUrl": "Remote control URL: {value}",
    "cli.status.remoteSecretFile": "Remote secret file: {value}",
    "cli.status.remoteAgent": "Remote agent: {value}",
    "cli.status.cloudflared": "cloudflared: {value}",
    "cli.status.cloudflaredLaunchd": "cloudflared launchd: {value}",
    ...
    "cli.doctor.issue.vpnEndpointHostnameMissing": "VPN_ENDPOINT_HOSTNAME is missing",
    "cli.doctor.issue.vpnLanIpMissing": "VPN_LAN_IP is missing",
    "cli.doctor.issue.vpnRequiresHttps": "VPN mode requires an HTTPS base URL",
    "cli.doctor.issue.remoteRequiresLan": "Cloudflare remote access requires ACCESS_MODE=lan",
    "cli.doctor.issue.remoteHostnameMissing": "REMOTE_ACCESS_PUBLIC_HOSTNAME is missing",
    "cli.doctor.issue.cloudflareAccountIdMissing": "CLOUDFLARE_ACCOUNT_ID is missing",
    "cli.doctor.issue.remoteAllowedEmailsMissing": "REMOTE_ACCESS_ALLOWED_EMAILS is missing",
    "cli.doctor.issue.remoteRequiresHttps": "Remote access requires an HTTPS LAN base URL",
    "cli.doctor.issue.cloudflareCredentialsMissing": "CLOUDFLARE_TUNNEL_CREDENTIALS_FILE is missing or unreadable",
    "cli.doctor.issue.cloudflareConfigMissing": "CLOUDFLARE_TUNNEL_CONFIG_FILE is missing or unreadable",
    "cli.doctor.issue.cloudflaredMissing": "cloudflared was not detected on this Mac",
    "cli.doctor.issue.managedRemoteInstallationMissing": "MANAGED_REMOTE_INSTALLATION_ID is missing",
    "cli.doctor.issue.managedRemotePublicUrlMissing": "MANAGED_REMOTE_PUBLIC_URL is missing",
    "cli.doctor.issue.managedRemoteControlUrlMissing": "MANAGED_REMOTE_CONTROL_URL is missing",
    "cli.doctor.issue.managedRemoteSecretFileMissing": "MANAGED_REMOTE_SECRET_FILE is missing or unreadable",
    "cli.doctor.issue.managedRemoteAgentMissing": "Managed remote agent token is missing or unreadable",
    ...
    "cli.doctor.issue.vpnProfileMissing": "VPN_PROFILE_FILE is missing or unreadable",
    "cli.doctor.issue.vpnCaMissing": "VPN_CA_CERT_FILE is missing or unreadable",
    "cli.doctor.issue.vpnServerCertMissing": "VPN_SERVER_CERT_FILE is missing or unreadable",
    "cli.doctor.issue.vpnSwanctlMissing": "VPN_SWANCTL_CONF_FILE is missing or unreadable",
    "cli.doctor.issue.vpnStrongSwanConfigMissing": "VPN_STRONGSWAN_CONF_FILE is missing or unreadable",
    "cli.doctor.issue.strongSwanMissing": "strongSwan was not detected on this Mac",
    ...
    "cli.doctor.vpnExternalNote":
      "External prerequisites are not checked automatically: public DNS and router UDP 500/4500 forwarding must be configured separately.",
    "cli.doctor.remoteLocalOnlyNote":
      "Cloudflare remote access was only checked locally. Export CLOUDFLARE_API_TOKEN before running doctor to verify tunnel, DNS, and Access resources.",
  },
  ja: {
    "common.codex": "Codex",
    "common.appName": "viveworker",
    ...
    "tab.diff.description": "Codex が加えた最近のファイル変更を iPhone で確認します。",
    "tab.code.title": "コード",
    "tab.code.label": "コード",
    "tab.code.eyebrow": "コード変更",
    "tab.code.description": "Codex が加えた最近のファイル変更を iPhone で確認します。",
    ...
    "empty.diff": "まだ表示できるファイル差分はありません。",
    ...
    "detail.diffThread.copy": ({ count }) => `このスレッドで変更があったファイルは ${count}件です。下でファイルごとに確認できます。`,
    ...
    "summary.diffThread": "このスレッドで変更されたファイルを確認します。",
    ...
    "intent.diffThread": "このスレッドで変更されたファイルを確認します。",
    ...
    "diff.latestChangeFallback": "このスレッドに最新変更があります。",
    ...
    "settings.status.expired": "期限切れ",
    "settings.remote.title": "Remote Access",
    "settings.remote.copy":
      "普段は LAN の viveworker を使い、外出したいときだけ一時的に外部 URL を発行します。",
    "settings.remote.configureOnMac":
      "まず Mac 側で `npx viveworker setup --access-mode viveworker` または `npx viveworker setup --access-mode cloudflare ...` を実行して remote access を設定してください。",
    "settings.remote.lanOnlyToggle":
      "Remote access の有効化・無効化は、LAN 版の viveworker からのみ行えます。",
    "settings.remote.publicUrlLabel": "外部アクセス URL",
    "settings.remote.bootstrapUrlLabel": "初回用 Bootstrap URL",
    "settings.remote.enable": "外部アクセスを有効化",
    "settings.remote.disable": "外部アクセスを無効化",
    "settings.remote.copyUrl": "外部 URL をコピー",
    "settings.remote.copyBootstrap": "Bootstrap URL をコピー",
    "settings.remote.openBootstrap": "Bootstrap URL を開く",
    "settings.remote.origin.lan": "LAN アプリ",
    "settings.remote.origin.remote": "外部 URL",
    "settings.remote.expiresMinutes": ({ count }) => `約 ${count} 分`,
    "settings.remote.expiresHours": ({ count }) => `約 ${count} 時間`,
    "settings.remote.expiresDays": ({ count }) => `約 ${count} 日`,
    ...
    "settings.row.currentOrigin": "現在の origin",
    "settings.row.remoteUrl": "外部アクセス URL",
    "settings.row.remoteExpires": "失効予定",
    "settings.row.remoteExpiresIn": "残り時間",
    "settings.row.remoteAllowEmails": "許可メール",
    ...
    "notice.remoteAccessEnabled": "外部アクセスを有効にしました。外出前に外部 URL を控えてください。",
    "notice.remoteAccessEnabledTrusted": "外部アクセスを有効にしました。この iPhone はすでに外部 URL 用に信頼済みです。",
    "notice.remoteAccessDisabled": "外部アクセスを無効にしました。",
    "notice.remoteUrlCopied": "外部 URL をコピーしました。",
    "notice.remoteBootstrapCopied": "Bootstrap URL をコピーしました。",
    "notice.remoteBootstrapOpened": "Bootstrap URL を新しいタブで開きました。",
    ...
    "error.copyUnavailable": "このブラウザではコピーできません。",
    "error.remoteAccessNotConfigured": "この Mac ではまだ remote access が設定されていません。",
    "error.remoteAccessLanOnly": "Remote access の変更は LAN 版の viveworker からのみ行えます。",
    "error.remoteBootstrapInvalid": "この外部アクセス用リンクは無効です。",
    "error.remoteBootstrapExpired": "この外部アクセス用リンクは期限切れです。LAN 版からもう一度有効化してください。",
    "error.remoteBootstrapDeviceRevoked": "この iPhone は remote access 用の信頼済み端末ではなくなりました。",
    "error.remoteBootstrapUnavailable": "いまは Bootstrap URL を用意できません。",
    "server.fallback.codexTask": "Codex task",
    ...
    "cli.help.remote": "remote        managed remote のコマンドです（現在は rotate のみ）",
    ...
    "cli.setup.progress.generateVpn": "VPN 証明書、profile、strongSwan 設定を生成しています...",
    "cli.setup.progress.remoteBootstrap": "remote access の bootstrap を準備しています...",
    ...
    "cli.setup.instructions.vpn":
      "Safari で app URL を開いて必要なら pairing し、ホーム画面に追加してください。LAN 外では、開く前に iPhone 標準 VPN を手動接続します。",
    "cli.setup.vpnFlow.title": "VPN 経由で viveworker を開く前に、生成された iPhone 用 VPN profile をインストールしてください:",
    "cli.setup.vpnFlow.downloadProfile": "VPN profile download: {url}",
    "cli.setup.vpnFlow.profilePath": "この Mac 上の VPN profile: {value}",
    "cli.setup.vpnFlow.step1": "1. 下の VPN profile URL を開くか QR を読み取り、iPhone で取得します。",
    "cli.setup.vpnFlow.step2": "2. profile をインストールし、iPhone の設定で証明書信頼を求められたら信頼します。",
    "cli.setup.vpnFlow.step3": "3. そのあと、このターミナルで Enter を押すと viveworker の接続先 URL と Pairing QR を表示します。",
    "cli.setup.vpnPortForward": "Router 設定: {host} 用に UDP 500 / 4500 をこの Mac へ port forward してください。",
    "cli.setup.vpnFirstInstallNote": "初回の profile インストールは、この Mac と同じ LAN 上の iPhone で行うのがおすすめです。",
    "cli.setup.remoteAccessProvider": "Remote access provider: {value}",
    "cli.setup.remoteAccessPublicUrl": "外部アクセス URL: {url}",
    "cli.setup.remoteAccessStatus": "Remote access: {value}",
    "cli.setup.remoteAccessDisabledByDefault":
      "Remote access は既定でオフのままです。外出前に iPhone の viveworker Settings から必要なときだけ有効化してください。",
    "cli.setup.remoteAccessIphoneToggle":
      "iPhone では Settings → Remote Access から、一時的な外部 URL を発行できます。",
    "cli.setup.remoteAccessAllowEmails": "Cloudflare Access の許可メール: {value}",
    ...
    "cli.status.detected": "検出済み",
    "cli.status.missing": "未検出",
    "cli.status.installed": "インストール済み",
    "cli.status.notRunning": "停止中",
    "cli.status.running": "稼働中",
    "cli.status.expired": "期限切れ",
    "cli.status.ok": "ok",
    "cli.status.failed": "failed",
    "cli.status.remoteConfigured": "Remote 設定: {value}",
    "cli.status.remoteUrl": "Remote URL: {value}",
    "cli.status.remoteEnabled": "Remote 動作状態: {value}",
    "cli.status.remoteExpiresAt": "Remote の失効予定: {value}",
    "cli.status.remoteControlUrl": "Remote control URL: {value}",
    "cli.status.remoteSecretFile": "Remote secret file: {value}",
    "cli.status.remoteAgent": "Remote agent: {value}",
    "cli.status.cloudflared": "cloudflared: {value}",
    ...
    "cli.doctor.issue.vpnEndpointHostnameMissing": "VPN_ENDPOINT_HOSTNAME がありません",
    "cli.doctor.issue.vpnLanIpMissing": "VPN_LAN_IP がありません",
    "cli.doctor.issue.vpnRequiresHttps": "VPN mode には HTTPS の base URL が必要です",
    "cli.doctor.issue.remoteRequiresLan": "Cloudflare remote access には ACCESS_MODE=lan が必要です",
    "cli.doctor.issue.remoteHostnameMissing": "REMOTE_ACCESS_PUBLIC_HOSTNAME がありません",
    "cli.doctor.issue.cloudflareAccountIdMissing": "CLOUDFLARE_ACCOUNT_ID がありません",
    "cli.doctor.issue.remoteAllowedEmailsMissing": "REMOTE_ACCESS_ALLOWED_EMAILS がありません",
    "cli.doctor.issue.remoteRequiresHttps": "Remote access には HTTPS の LAN base URL が必要です",
    "cli.doctor.issue.cloudflareCredentialsMissing": "CLOUDFLARE_TUNNEL_CREDENTIALS_FILE がないか、読み取れません",
    "cli.doctor.issue.cloudflareConfigMissing": "CLOUDFLARE_TUNNEL_CONFIG_FILE がないか、読み取れません",
    "cli.doctor.issue.cloudflaredMissing": "この Mac で cloudflared が検出できませんでした",
    "cli.doctor.issue.managedRemoteInstallationMissing": "MANAGED_REMOTE_INSTALLATION_ID がありません",
    "cli.doctor.issue.managedRemotePublicUrlMissing": "MANAGED_REMOTE_PUBLIC_URL がありません",
    "cli.doctor.issue.managedRemoteControlUrlMissing": "MANAGED_REMOTE_CONTROL_URL がありません",
    "cli.doctor.issue.managedRemoteSecretFileMissing": "MANAGED_REMOTE_SECRET_FILE がないか、読み取れません",
    "cli.doctor.issue.managedRemoteAgentMissing": "managed remote agent token がないか、読み取れません",
    ...
    "cli.doctor.issue.vpnProfileMissing": "VPN_PROFILE_FILE がないか、読み取れません",
    "cli.doctor.issue.vpnCaMissing": "VPN_CA_CERT_FILE がないか、読み取れません",
    "cli.doctor.issue.vpnServerCertMissing": "VPN_SERVER_CERT_FILE がないか、読み取れません",
    "cli.doctor.issue.vpnSwanctlMissing": "VPN_SWANCTL_CONF_FILE がないか、読み取れません",
    "cli.doctor.issue.vpnStrongSwanConfigMissing": "VPN_STRONGSWAN_CONF_FILE がないか、読み取れません",
    "cli.doctor.issue.strongSwanMissing": "この Mac で strongSwan が検出できませんでした",
    ...
    "cli.doctor.vpnExternalNote": "external prerequisite は自動確認されません。public DNS と router の UDP 500 / 4500 port forward は別途設定が必要です。",
    "cli.doctor.remoteLocalOnlyNote":
      "Cloudflare remote access はローカル確認のみ実施しました。tunnel / DNS / Access resource まで検証するには、doctor 実行前に CLOUDFLARE_API_TOKEN を export してください。",
  },
};
